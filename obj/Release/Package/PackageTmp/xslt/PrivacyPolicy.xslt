...
<!-- start writing XSLT -->
		<section id="Terms">
  <div class="container">
  <h3><xsl:value-of select="$currentPage/privacyPolicyTiltle"/></h3>
 
  
 
  <div class="col-sm-8 col-xs-offset-2 termsconditions">
  <p style="text-align:left;"><xsl:value-of select="$currentPage/privacyPolicyDescription" disable-output-escaping="yes"/></p>
