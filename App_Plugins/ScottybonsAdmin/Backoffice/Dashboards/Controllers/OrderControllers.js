...
angular.module('umbraco').controller('AdminOrderCtrl', ['$scope', '$http', 'uiGridConstants', '$interval', '$modal', '$log',
    function ($scope, $http, $interval, uiGridConstants, $modal, $log) {
    var data = [];
...
angular.module('umbraco').controller('MainCtrl', ['$scope', '$http', 'uiGridConstants', '$interval', '$modal', '$log', function ($scope, $http, uiGridConstants, $interval, $modal, $log) {
